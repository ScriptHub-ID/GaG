loadstring(game:HttpGet("https://pastefy.app/tEbeRmhN/raw"))()
...
local petTable = {
    ...
    ["Enchanted Egg"] = { "Ladybug", "Pixie", "Imp", "Glimmering Sprite" },
}
...
subtitle.Position = UDim2.new(0, 5, 0, 25)
subtitle.BackgroundTransparency = 1
subtitle.Text = "Made by Pxz and Kodamatzk"
...
randomizeBtn.Position = UDim2.new(0, 10, 0, 55)
